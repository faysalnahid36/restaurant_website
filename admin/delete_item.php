    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
			...
			<div class="span6 sidebar">
					...
					<h3 class="sidebox-title">Delete Item</h3>
...
?>		
				...
				echo"<div class='modal fade' id='$category_name' tabindex='-1' role='dialog'>";
					echo"<div class='modal-dialog'>";
						echo"<div class='modal-content'>";
							...
							echo"<form action='action_delete_item.php' enctype='multipart/form-data' method='post'>";
							echo"<fieldset>";
							echo"<label>Select a Item: </label>";
							echo"<select id='sc' name='item_name' class='input-block-level'>";
	...
	echo"<input type='submit' value='Delete' name='delete' id='submitButton' class='btn btn-info pull-right' title='Click here to submit your message!' />";
	echo"</div>";
