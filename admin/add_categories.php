        ...
        <div class="divPanel notop page-content">
			...
			<div class="span6 sidebar">
				...
				?>
					...
					<h3 class="sidebox-title">Add Here</h3>
					
					
                   
				   <!--Start Contact form -->		                                                
<form action="action_add_categories.php" enctype="multipart/form-data" method="post">
  <fieldset>
	<input type="text" name="category_name" id="name" value=""  class="input-block-level" placeholder="Category Name" required /></br></br>
    <input type="text" name="serial" id="serial" value="" class="input-block-level" placeholder="Serial Id" required/></br></br>
	<input name="uploadedimage" type="file" class="input-block-level"  required></br>
    <div class="actions">
	<input type="submit" value="Add" name="Upload Now" id="submitButton" class="btn btn-info pull-right" title="Click here to submit your message!" />
	</div>
