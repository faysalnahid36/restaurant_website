        ...
        <div class="divPanel notop page-content">
			...
			<div class="span6 sidebar">
				...
				?>
					...
					<h3 class="sidebox-title">Item Add Here</h3>
                   
				   <!--Start Contact form -->		                                                
<form action="action_add_item.php" enctype="multipart/form-data" method="post">
  <fieldset>
	...
	<input type="text" name="item_name" id="name" value=""  class="input-block-level" placeholder="Item Name" required /></br></br>
	<textarea rows="11" name="item_details" id="message" class="input-block-level" placeholder="Details" required ></textarea> </br></br>
