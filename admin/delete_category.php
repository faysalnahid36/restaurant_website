        ...
        <div class="divPanel notop page-content">
			...
			<div class="span6 sidebar">
				...
				?>   
					...
					<h3 class="sidebox-title">Delete Here</h3>
                   
				   <!--Start Contact form -->		                                                
<form name="enq" action="action_delete_categories.php" method="post">
  <fieldset>
    ...
    <div class="actions">
	<input type="submit" value="Delete" name="submit" id="submitButton" class="btn btn-info pull-right" title="Click here to submit your message!" />
	</div>
